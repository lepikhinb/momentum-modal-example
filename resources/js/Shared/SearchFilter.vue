<template>
  <div class="flex items-center">
    <div class="flex w-full rounded bg-white shadow">
      <dropdown
        :auto-close="false"
        class="rounded-l border-r px-4 hover:bg-gray-100 focus:z-10 focus:border-white focus:ring md:px-6"
      ...
      <input
        class="relative w-full rounded-r px-6 py-3 focus:shadow-outline"
        autocomplete="off"
        type="text"
        name="search"
        placeholder="Search…"
